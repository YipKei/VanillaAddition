...
public class ModBlockTagProvider extends FabricTagProvider.BlockTagProvider {
    ...
    protected void configure(RegistryWrapper.WrapperLookup arg) {
        ...
        getOrCreateTagBuilder(ModTags.Blocks.DEEP_DARK_FANTASY_AFFECTABLE)
                .add(Blocks.WITHER_SKELETON_WALL_SKULL)
                .add(Blocks.WITHER_SKELETON_SKULL)
                .add(Blocks.TURTLE_EGG)
                ;

        getOrCreateTagBuilder(ModTags.Blocks.EXPLOSION_CREATOR_AFFECTABLE)
                .add(Blocks.CREEPER_HEAD)
                .add(Blocks.CREEPER_WALL_HEAD)
                ;

        getOrCreateTagBuilder(ModTags.Blocks.MAGICAL_GIRLS_AFFECTABLE)
