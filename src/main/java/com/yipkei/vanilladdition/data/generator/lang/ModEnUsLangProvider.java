...
public class ModEnUsLangProvider extends FabricLanguageProvider {
    ...
    public void generateTranslations(RegistryWrapper.WrapperLookup registryLookup, TranslationBuilder translationBuilder) {
        ...
        translationBuilder.add(ModItems.DIAMOND_GRAVER,                 "Diamond Graver");
        ...
        translationBuilder.add(ModItems.IRON_HORSE_ARMOR_BLUEPRINT, "Iron Horse Armor Blueprint");
        translationBuilder.add(ModItems.GOLDEN_HORSE_ARMOR_BLUEPRINT, "Golden Horse Armor Blueprint");
        translationBuilder.add(ModItems.DIAMOND_HORSE_ARMOR_BLUEPRINT, "Diamond Horse Armor Blueprint");
        ...
        translationBuilder.add(ModItems.GLASS_DISC,                         "Glass Disc");
        translationBuilder.add(ModItems.EMPTY_SHEET_MUSIC,                  "Empty Sheet Music");
        translationBuilder.add(ModItems.MUSIC_DISC_13_SHEET_MUSIC,          "Sheet Music 13");
        translationBuilder.add(ModItems.MUSIC_DISC_CAT_SHEET_MUSIC,         "Sheet Music Cat");
        translationBuilder.add(ModItems.MUSIC_DISC_BLOCKS_SHEET_MUSIC,      "Sheet Music Block");
        translationBuilder.add(ModItems.MUSIC_DISC_CHIRP_SHEET_MUSIC,       "Sheet Music Chirp");
        translationBuilder.add(ModItems.MUSIC_DISC_CREATOR_SHEET_MUSIC,     "Sheet Music Creator");
        translationBuilder.add(ModItems.MUSIC_DISC_CREATOR_MUSIC_BOX_SHEET_MUSIC, "Sheet Music Creator(Music Box)");
        translationBuilder.add(ModItems.MUSIC_DISC_FAR_SHEET_MUSIC,         "Sheet Music Far");
        translationBuilder.add(ModItems.MUSIC_DISC_MALL_SHEET_MUSIC,        "Sheet Music Mall");
        translationBuilder.add(ModItems.MUSIC_DISC_MELLOHI_SHEET_MUSIC,     "Sheet Music Mellohi");
        translationBuilder.add(ModItems.MUSIC_DISC_STAL_SHEET_MUSIC,        "Sheet Music Stal");
        translationBuilder.add(ModItems.MUSIC_DISC_STRAD_SHEET_MUSIC,       "Sheet Music Strad");
        translationBuilder.add(ModItems.MUSIC_DISC_WARD_SHEET_MUSIC,        "Sheet Music Ward");
        translationBuilder.add(ModItems.MUSIC_DISC_11_SHEET_MUSIC,          "Sheet Music 11");
        translationBuilder.add(ModItems.MUSIC_DISC_WAIT_SHEET_MUSIC,        "Sheet Music Wait");
        translationBuilder.add(ModItems.MUSIC_DISC_OTHERSIDE_SHEET_MUSIC,   "Sheet Music Otherside");
        translationBuilder.add(ModItems.MUSIC_DISC_RELIC_SHEET_MUSIC,       "Sheet Music Relic");
        translationBuilder.add(ModItems.MUSIC_DISC_5_SHEET_MUSIC,           "Sheet Music 5");
        translationBuilder.add(ModItems.MUSIC_DISC_PIGSTEP_SHEET_MUSIC,     "Sheet Music Pigstep");
        translationBuilder.add(ModItems.MUSIC_DISC_PRECIPICE_SHEET_MUSIC,   "Sheet Music Precipice");
