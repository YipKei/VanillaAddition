...
public class ModBlockTagProvider extends FabricTagProvider.BlockTagProvider {
    ...
    protected void configure(RegistryWrapper.WrapperLookup arg) {
        ...
        getOrCreateTagBuilder(ModTags.Blocks.WORLD_DESTROYER)
                ...
                .add(Blocks.ANCIENT_DEBRIS ,Blocks.OBSIDIAN,Blocks.CRYING_OBSIDIAN)
                .add(Blocks.VAULT, Blocks.TRIAL_SPAWNER, Blocks.REINFORCED_DEEPSLATE, Blocks.RESPAWN_ANCHOR)
