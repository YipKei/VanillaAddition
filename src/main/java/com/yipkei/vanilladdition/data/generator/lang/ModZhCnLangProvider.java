...
public class ModZhCnLangProvider extends FabricLanguageProvider {
    ...
    public void generateTranslations(RegistryWrapper.WrapperLookup registryLookup, TranslationBuilder translationBuilder) {
        ...
        translationBuilder.add(ModItems.STEEL_HELMET,                   "钢盔");
        translationBuilder.add(ModItems.STEEL_CHESTPLATE,               "钢甲");
        translationBuilder.add(ModItems.STEEL_LEGGINGS,                 "钢裤");
        translationBuilder.add(ModItems.STEEL_BOOTS,                    "钢鞋");
        ...
        translationBuilder.add(ModItems.IRON_HORSE_ARMOR_BLUEPRINT, "铁马铠图纸");
        translationBuilder.add(ModItems.GOLDEN_HORSE_ARMOR_BLUEPRINT, "金马铠图纸");
        translationBuilder.add(ModItems.DIAMOND_HORSE_ARMOR_BLUEPRINT, "钻石马铠图纸");
        ...
        translationBuilder.add(ModItems.GLASS_DISC,                         "玻璃光盘");
        translationBuilder.add(ModItems.EMPTY_SHEET_MUSIC,                  "空乐谱");
        translationBuilder.add(ModItems.MUSIC_DISC_13_SHEET_MUSIC,          "乐谱《13》");
        translationBuilder.add(ModItems.MUSIC_DISC_CAT_SHEET_MUSIC,         "乐谱《Cat》");
        translationBuilder.add(ModItems.MUSIC_DISC_BLOCKS_SHEET_MUSIC,      "乐谱《Block》");
        translationBuilder.add(ModItems.MUSIC_DISC_CHIRP_SHEET_MUSIC,       "乐谱《Chirp》");
        translationBuilder.add(ModItems.MUSIC_DISC_CREATOR_SHEET_MUSIC,     "乐谱《Creator》");
        translationBuilder.add(ModItems.MUSIC_DISC_CREATOR_MUSIC_BOX_SHEET_MUSIC, "乐谱《Creator》（音乐盒）");
        translationBuilder.add(ModItems.MUSIC_DISC_FAR_SHEET_MUSIC,         "乐谱《Far》");
        translationBuilder.add(ModItems.MUSIC_DISC_MALL_SHEET_MUSIC,        "乐谱《Mall》");
        translationBuilder.add(ModItems.MUSIC_DISC_MELLOHI_SHEET_MUSIC,     "乐谱《Mellohi》");
        translationBuilder.add(ModItems.MUSIC_DISC_STAL_SHEET_MUSIC,        "乐谱《Stal》");
        translationBuilder.add(ModItems.MUSIC_DISC_STRAD_SHEET_MUSIC,       "乐谱《Strad》");
        translationBuilder.add(ModItems.MUSIC_DISC_WARD_SHEET_MUSIC,        "乐谱《Ward》");
        translationBuilder.add(ModItems.MUSIC_DISC_11_SHEET_MUSIC,          "乐谱《11》");
        translationBuilder.add(ModItems.MUSIC_DISC_WAIT_SHEET_MUSIC,        "乐谱《Wait》");
        translationBuilder.add(ModItems.MUSIC_DISC_OTHERSIDE_SHEET_MUSIC,   "乐谱《Otherside》");
        translationBuilder.add(ModItems.MUSIC_DISC_RELIC_SHEET_MUSIC,       "乐谱《Relic》");
        translationBuilder.add(ModItems.MUSIC_DISC_5_SHEET_MUSIC,           "乐谱《5》");
        translationBuilder.add(ModItems.MUSIC_DISC_PIGSTEP_SHEET_MUSIC,     "乐谱《Pigstep》");
        translationBuilder.add(ModItems.MUSIC_DISC_PRECIPICE_SHEET_MUSIC,   "乐谱《Precipice》");
        
        //方块
        translationBuilder.add(ModBlocks.STEEL_BLOCK,                   "钢块");
        translationBuilder.add(ModBlocks.COMPRESS_WOOL,                 "压缩羊毛");

        translationBuilder.add(ModBlocks.STONE_BLIND_BOX,               "石头盲盒");
        translationBuilder.add(ModBlocks.COAL_BLIND_BOX,                "非洲盲盒");
        translationBuilder.add(ModBlocks.COPPER_BLIND_BOX,              "铜盲盒");
        translationBuilder.add(ModBlocks.IRON_BLIND_BOX,                "铁盲盒");
        ...
        translationBuilder.add(ModBlocks.OMINOUS_IRON_BLIND_BOX,        "不详的铁盲盒");
        translationBuilder.add(ModBlocks.OMINOUS_GOLDEN_BLIND_BOX,      "不详的金盲盒");
        translationBuilder.add(ModBlocks.OMINOUS_EMERALD_BLIND_BOX,     "不详的绿宝石盲盒");
        translationBuilder.add(ModBlocks.OMINOUS_DIAMOND_BLIND_BOX,     "不详的钻石盲盒");
        translationBuilder.add(ModBlocks.OMINOUS_NETHERITE_BLIND_BOX,   "不详的至尊无敌大盲盒");
        ...
        translationBuilder.add("entity.minecraft.villager."+ Registries.VILLAGER_PROFESSION.getId(ModVillagers.VAULT_TRADER).getPath(), "宝库商人");
