...
public class ModLootTableModifiers {
    ...
    private static final RegistryKey<LootTable> BASTION_TREASURE =          registerKey("minecraft", "chests/bastion_treasure");
    private static final RegistryKey<LootTable> BASTION_BRIDGE =            registerKey("minecraft", "chests/bastion_bridge");
    private static final RegistryKey<LootTable> BASTION_HOGLIN_STABLE =     registerKey("minecraft", "chests/bastion_hoglin_stable");
    private static final RegistryKey<LootTable> BASTION_OTHER =             registerKey("minecraft", "chests/bastion_others");
    private static final RegistryKey<LootTable> END_CITY_TREASURE = registerKey("minecraft", "chests/end_city_treasure");
    private static final RegistryKey<LootTable> ANCIENT_CITY = registerKey("minecraft", "chests/ancient_city");
    ...
    private static LootPool.Builder createSimpleLootPool(float rolls, ItemConvertible drops){
        return LootPool.builder()
                ...
                .with(ItemEntry.builder(drops).apply(SetCountLootFunction.builder(ConstantLootNumberProvider.create(1.0F))));
    }

    private static LootPool.Builder createSimpleLootPool(float rolls, ItemConvertible drops, float minCount, float maxCount){
        return LootPool.builder()
                .rolls(ConstantLootNumberProvider.create(rolls))
                .with(ItemEntry.builder(drops).apply(SetCountLootFunction.builder(UniformLootNumberProvider.create(minCount, maxCount))))
                ;
    }
    ...
    private static LootPool.Builder createSimpleWeightLootPool(float rolls, ItemConvertible drops, int emptyWeight, int itemWeight){
        return LootPool.builder()
                .rolls(ConstantLootNumberProvider.create(rolls))
                .with(ItemEntry.builder(drops).weight(itemWeight).apply(SetCountLootFunction.builder(ConstantLootNumberProvider.create(1.0F))))
                .with(EmptyEntry.builder().weight(emptyWeight).apply(SetCountLootFunction.builder(ConstantLootNumberProvider.create(1.0f))));
    }
    ...
    private static LootPool.Builder createSimpleWeightLootPool(float rolls, int emptyWeight, ItemConvertible drops, int itemWeight, float minCount, float maxCount){
        return LootPool.builder()
                ...
                .with(EmptyEntry.builder().weight(emptyWeight).apply(SetCountLootFunction.builder(UniformLootNumberProvider.create(minCount, maxCount))))
                ;
    }
    ...
    private static LootPool.Builder createMultipleWeightLootPool(float rolls, int emptyWeight, ItemConvertible drops1, int itemWeight1, ItemConvertible drops2, int itemWeight2){
        return LootPool.builder()
                .rolls(ConstantLootNumberProvider.create(rolls))
                .with(ItemEntry.builder(drops1).weight(itemWeight1).apply(SetCountLootFunction.builder(ConstantLootNumberProvider.create(1.0F))))
                .with(ItemEntry.builder(drops2).weight(itemWeight2).apply(SetCountLootFunction.builder(ConstantLootNumberProvider.create(1.0F))))
    ...
    private static LootPool.Builder createMultipleWeightLootPool(float rolls, int emptyWeight, ItemConvertible drops1, int itemWeight1, ItemConvertible drops2, int itemWeight2, ItemConvertible drops3, int itemWeight3){
        return LootPool.builder()
                ...
                .with(ItemEntry.builder(drops1).weight(itemWeight1).apply(SetCountLootFunction.builder(ConstantLootNumberProvider.create(1.0F))))
                .with(ItemEntry.builder(drops2).weight(itemWeight2).apply(SetCountLootFunction.builder(ConstantLootNumberProvider.create(1.0F))))
                .with(ItemEntry.builder(drops3).weight(itemWeight3).apply(SetCountLootFunction.builder(ConstantLootNumberProvider.create(1.0F))))
                .with(EmptyEntry.builder().weight(emptyWeight));
    }
    ...
    private static LootPool.Builder createMultipleWeightLootPool(float rolls, int emptyWeight, ItemConvertible drops1, int itemWeight1, ItemConvertible drops2, int itemWeight2, ItemConvertible drops3, int itemWeight3, ItemConvertible drops4, int itemWeight4){
        return LootPool.builder()
                ...
                .with(ItemEntry.builder(drops2).weight(itemWeight2).apply(SetCountLootFunction.builder(ConstantLootNumberProvider.create(1.0F))))
                .with(ItemEntry.builder(drops3).weight(itemWeight3).apply(SetCountLootFunction.builder(ConstantLootNumberProvider.create(1.0F))))
                .with(ItemEntry.builder(drops4).weight(itemWeight4).apply(SetCountLootFunction.builder(ConstantLootNumberProvider.create(1.0F))))
                .with(EmptyEntry.builder().weight(emptyWeight));
    }
    ...
    private static LootPool.Builder createMultipleWeightLootPool(float rolls, int emptyWeight, ItemConvertible drops1, int itemWeight1, ItemConvertible drops2, int itemWeight2, ItemConvertible drops3, int itemWeight3, ItemConvertible drops4, int itemWeight4, ItemConvertible drops5, int itemWeight5){
        return LootPool.builder()
                ...
                .with(ItemEntry.builder(drops3).weight(itemWeight3).apply(SetCountLootFunction.builder(ConstantLootNumberProvider.create(1.0F))))
                .with(ItemEntry.builder(drops4).weight(itemWeight4).apply(SetCountLootFunction.builder(ConstantLootNumberProvider.create(1.0F))))
                .with(ItemEntry.builder(drops5).weight(itemWeight5).apply(SetCountLootFunction.builder(ConstantLootNumberProvider.create(1.0F))))
                .with(EmptyEntry.builder().weight(emptyWeight));
    }
